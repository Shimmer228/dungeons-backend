...
export type StorageHash =
  StorageHashBase<'820a62d82917964d0613b27ed8370e6b657794272c2d8f076ba93b6dcd3886e9'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Character: {
      ...
      readonly race: CodecTypes['pg/text@1']['output'];
      ...
      readonly maxHp: CodecTypes['pg/int4@1']['output'];
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly Character: {
      ...
      readonly race: CodecTypes['pg/text@1']['input'];
      readonly level: CodecTypes['pg/int4@1']['input'];
      readonly class: CodecTypes['pg/text@1']['input'];
      readonly hp: CodecTypes['pg/int4@1']['input'];
      readonly maxHp: CodecTypes['pg/int4@1']['input'];
    };
  };
};
          ...
          readonly Character: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly race: { readonly column: 'race' };
                readonly level: { readonly column: 'level' };
                readonly class: { readonly column: 'class' };
                readonly hp: { readonly column: 'hp' };
                readonly maxHp: { readonly column: 'maxHp' };
              };
            };
          };
        };
